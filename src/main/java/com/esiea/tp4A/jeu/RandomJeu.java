...
public class RandomJeu implements Serializable {
    ...
    public Rover generateRandomRover(Jeu jeu, Set<Obstacle> obstacles, HashMap<String, Rover> rovers, int laserRange, Mars map, String player){
        ...
        while(true){
            ...
            Rover rover = new Rover(jeu, player_position.getX(), player_position.getY(), randomDirection, laserRange, map, player);
