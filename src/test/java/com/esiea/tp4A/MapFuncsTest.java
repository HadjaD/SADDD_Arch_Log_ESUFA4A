...
public class MapFuncsTest {
    ...
    void roversComparaison(){
        ...
        Rover myRover = new Rover(new Jeu("game", mars), 0, 1, Direction.NORTH, 5, mars, "");
        HashMap<String, Rover> testHasp = new HashMap<String, Rover>();
        testHasp.put("", myRover);
        Set<Rover> rovers = mapFuncs.comparePointsToRovers(testHasp, Stream.of(new CircularPoint(0,1,100)).collect(Collectors.toSet()));
