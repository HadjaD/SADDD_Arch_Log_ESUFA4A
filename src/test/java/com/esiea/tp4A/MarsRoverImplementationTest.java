...
public class MarsRoverImplementationTest {
    PlanetMapInit map = new PlanetMapInit(100, 100, 0.15);
    int height;
    int weight;
    @Before
    public void beforeTestCreateGrid() {
        map = new PlanetMapInit(100, 100, 0.15);
    ...
    void rover_moves_forward_backward(String command, int expectedX, int expectedY, Direction expectedDirection) {
        MarsRover marsRover = new MarsRoverImplementation(0, 0, Direction.NORTH, map);
