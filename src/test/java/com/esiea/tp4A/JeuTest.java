...
public class JeuTest {
    private final RandomJeu randomGame = new RandomJeu();
    ...
    private final Jeu theGame = new Jeu("game",planetMap);
    ...
    void checkUnknownPlayer(){
        Rover myRover = theGame.retrieveRoverByPlayer("unknown");
    ...
    void checkOverLoadRovers(){
        ...
        Rover myRover = theGame.createPlayer("player55");
